...
/**
 * responsable de l'audio des billes, c-à-d responsable du mouvement de la liste des billes. met perpétuellement à jour les billes.
 ...
 * */
public class AudiosBilles implements Runnable
{
     ...
     * @param vueBillard
     */
    public AudiosBilles(Vector<Bille> billes, VueBillard vueBillard)
    {
        this.billes = billes;
    ...
    public void run()
    {
        try
        {
            ...
            double minRayons = AudiosBilles.minRayons(billes);   //nécessaire au calcul de deltaT
